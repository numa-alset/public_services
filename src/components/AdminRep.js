...
const AdminRep = () => {
    ...
    useEffect(() => {
        // let id = auth;
        console.log(id);
        axios.get('https://dani2.pythonanywhere.com/mechanicals/' + id).then(data => {
            setUser(data.data.mechanical_name)
            setSpec(data.data.ip_type)
    ...
    const handleSubmit = async (e) => {
        ...
        console.log(JSON.stringify({ "longitude": 44.55 }));
        await axios.put('https://dani2.pythonanywhere.com/mechanicals/' + id+'/',
            JSON.stringify({ }),
            {
    ...
    const submitFile = () => {
        ...
        axios.put('https://dani2.pythonanywhere.com/mechanicals/' + id + '/', {picture:file}, {
            headers: {
    ...
    return (
        <div className="my-accountt">
            <div className="sidebarr">
                <a className="map-parentt" href="/map4">
            ...
            <div className="bodyy">
                ...
                <div style={{ position: "relative", borderRadius: "1.77px", backgroundColor: "#fff", boxShadow: "0px 11.797619819641113px 14.75px rgba(0, 0, 0, 0.05), 0px 0px 3.54px rgba(0, 0, 0, 0.15), 0px 2.3595240116119385px 2.36px rgba(0, 0, 0, 0.25)", width: "30%", height: "216px", overflow: "hidden", textAlign: "center", fontSize: "15px", color: "#000", fontFamily: "'DM Sans'", }}>
                    ...
                    <div style={{ position: "absolute", height: "64.35%", width: "80%", top: "24.07%", right: "4.35%", bottom: "11.57%", left: "15.65%", borderRadius: "5px", backgroundColor: "#ececec", display: "flex", flexDirection: "row", padding: "15px 25px", boxSizing: "border-box", alignItems: "flex-start", justifyContent: "flex-start", color: "#747474", fontFamily: "Poppins", }}>
                        <input type="description" onChange={(e) => setDes(e.target.value)} style={{ position: "relative", lineHeight: "15px", width: '90%' }} placeholder="example time open, close ect..." />
                    </div>
                </div>
                ...
                <div className="select" style={{ position: "relative", top: "-153px", left: "500px", lineHeight: "20px" }}>
                    ...
                    <select class="input" onChange={(e) => setSpec(e.target.value)} value={type}>
                        <option class="text" value="EL"> Electrical   </option>
                        <option class="text" value="Mechanical">Mechanical</option>
                        <option class="text" value="Other">Other</option>
                    </select><br />
                    <select class="input" onChange={(e) => setType(e.target.value)} value={spec}>
                ...
                <div className="buttons-wrapperr" style={{ top: '650px' }}>
