...
// }
    ...
    useEffect(() => {
        ...
        map2.on("load", async function () {
            ...
            //         const geoJson=data;
            //     });
            const geoJson = await axios.get("https://dani2.pythonanywhere.com/hospitals/").then(response => response.data)
                .then(data => {
                    let features = [];
