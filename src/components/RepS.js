   ...
   // const [id, setid] = useState(localStorage.getItem('id'));
    ...
    const handleSubmit = async (e) => {
        ...
        await axios.put('https://dani2.pythonanywhere.com/mechanicals/' + id + '/',
            JSON.stringify({ ip_type: select, mechanical_name: user, holiday: day, longitude: long, laditude: lat }),
            {
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="Your E-mail">
                    <select class="input" onChange={(e) => setDay(e.target.value)} value={day}>
                        ...
                        <option class="text" value="ME">Mechanical</option>
                        <option class="text" value="OT">Other</option>
                    </select>
                </div>
