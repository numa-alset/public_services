...
const Map2 = () => {
    ...
    useEffect(() => {
        ...
        // filterGroup.style.left='-170px';
        // filterInput.style.left='160px';
        ...
        map2.on("load", async function () {
            ...
            //         const geoJson=data;
            //     });
            const geoJson = await axios.get("https://dani2.pythonanywhere.com/mechanicals/").then(response => response.data)
                .then(data => {
                    let features = [];
